...
class AppStyle {
  ...
  // static Color darkHoverBrown = const Color(0xff6F6D6D);
  // static Color darkPressedBrown = const Color(0xffA3A2A2);
  ...
  // static Color homeBottomGradient = const Color(0xff71BE6D);
  // static Color resultGreen = const Color(0xff9FCE7B);
  // static Color resultYellow = const Color(0xffFDCA00);
  // static Color resultOrange = const Color(0xffFF961D);
  // static Color resultRedTop = const Color(0xffFF7070);
  // static Color resultRedMiddle = const Color(0xffFF6161);
  ...
  // static Color learnBlue = const Color(0xff00A5C6);
  ...
  // static Color grey400 = const Color(0xFFFAFBFB);
  ...
  // static Color hoverWhite = Color(0xffe6ecea);
